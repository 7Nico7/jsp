...
public class GetMantenimientos {
    ...
    private String SQL(String tabla) {
        String sql = """
         Select b.cve_bienes, cve_fecha_mante_camb as cve_mantenimiento, tipo, num_inventario, fecha, (90 - DATEDIFF('2022-10-30', fecha)) as dias_restantes, descripcion, DATE_ADD(fecha, INTERVAL 90 DAY) as proximo_mantenimiento, archivo, nombre_archivo from bienes as b
