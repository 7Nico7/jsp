...
public class GetMantenimiento_Id {
    ...
    public Mantenimientos GetMantnimientoID(String cve_mantenimiento, String tipo_bien, String num_inventario) {
        ...
        String sql = """
                     select cve_fecha_mante_camb, cve_bienes, tm.nombre as cve_tipoMantenimiento, f.nombre as cve_fallas, fecha, descripcion, archivo, nombre_archivo, cambio_et, tornner_cambiado  from fecha_mante_camb as fmc
