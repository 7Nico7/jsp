...
public class ActualizarBien {
    ...
    public String Actualizar(Bienes b) {
        final String sql = "UPDATE bienes SET cve_tipoBien = ?, cve_estado = ?, marca = ?, modelo = ?, fecha_instalacion = ?, "
                + "fecha_factura = ?, num_inventario = ?, unidad = ?, serie = ?\n"
                + "Where cve_bienes=?";
        String mensaje = "";
        int id;
        Connection cn = null;
    ...
    private void ubicacion(Bienes b, Connection cn) {
        final String sql = "UPDATE ubicaciones SET ubic_departamento = ?, departamento = ?, dependencia = ?, area = ?, responsable = ?, observaciones = ?\n"
                + "Where cve_bienes = ?;";
        PreparedStatement ps = null;
        try {
            ps = cn.prepareStatement(sql);
    ...
    private void tonners(Bienes b, Connection cn) {
        final String sql = "UPDATE tonners SET nombre = ? Where cve_bienes = ?;";
