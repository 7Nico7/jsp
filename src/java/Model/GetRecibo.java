...
public class GetRecibo {
    ...
    public String getRecibo() {
        String sql = "select cve_recibo, cve_medidor, recibo_year, periodo, consumo, saldo, archivo, nombre_archivo, periodo_inicio, periodo_final from recibo;";
        String json = null;
        Gson gson = new Gson();
        Conexion con = null;
    ...
    public String getReciboOrdenMasReciente() {
        String sql = "select cve_recibo, cve_medidor, recibo_year, periodo, consumo, saldo, archivo, nombre_archivo, periodo_inicio, periodo_final from recibo order by periodo_inicio DESC;";
        String json = null;
        Gson gson = new Gson();
        Conexion con = null;
        List<Recibo> recibos = new ArrayList<>();
    ...
    public String getReciboId(int cve_recibo) {
        String sql = """
                     ...
                     archivo, nombre_archivo, periodo_inicio, periodo_final, medidor from recibo as re
    ...
    public String getReciboId_MasReciente(int cve_medidor) {
        String sql = """
                     select cve_medidor, periodo_inicio, nombre_archivo
                     archivo, nombre_archivo  from recibo where cve_medidor = ? order by periodo_inicio DESC limit 1;""";
        String json = null;
        Gson gson = new Gson();
        Conexion con = null;
        ResultSet rs = null;
    ...
    public String getReciboId_medidor(int cve_medidor) {
        String sql = "select cve_recibo, cve_medidor, recibo_year, periodo, consumo, saldo, archivo, nombre_archivo from recibo where cve_medidor = ?;";
        String json = null;
        Gson gson = new Gson();
        Conexion con = null;
        ResultSet rs = null;
