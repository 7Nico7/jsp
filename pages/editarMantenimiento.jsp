                    ...
                    <div class="card-body">
                        <form action="ControllerEditar?Editar=Mantenimiento" method="post" enctype="multipart/form-data" onsubmit="actualizar.disabled = true; return true;">
                            <div class="form-row" >
                                ...
                                <div class="form-group col-md-3" id="tonnerCambiar" style="display:none">
                                ...
                                <div class="form-group col-md-4" id="evidenciaVista" style="display:none">
                                    <label for="evidencia">Subir video</label>
                                    <input style="background-color:rgba(179,142,93,1)" type="file" class="form-control-file" name="evidencia" id="evidencia">
                                </div>
                            </div>
