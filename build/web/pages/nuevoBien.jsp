        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="ControllerLogin?accion=usuarios">Usuarios</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="ControllerLogin?accion=perfil">Perfil</a>
                    </li>
                </ul>
    ...
    <div class="container">
        <div class="col-md-17">
            <div class="card">
                ...
                ${mensaje}
                <div class="card-body">
                    <form action="ControllerBienes?guardar=bien" method="post" onsubmit="guardar.disabled = true; return true;">
                        <div class="form-row" >
                        ...
                        <div class="form-group" align="center">
                            ...
                            <button disabled="true" id="guardar" name="guardar"  class="btn btn-primary">Guardar</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        function cambiarForm() {
            ...
            function climas(accion) {
                var campos = ['Odescripcion', 'marc', 'model', 'numSerie', 'numInventario', 'fechaF',
                    'fechaI', 'ubica', 'respon', 'depend', 'departame', 'ubicObser', 'areaO', 'estado', 'archivo'];
            ...
            function impresoras(accion) {
                var campos = ['marc', 'model', 'numSerie', 'numInventario', 'ubica', 'respon', 'estado', 'toner', 'archivo'];
                for (var i = 0; i < campos.length; i++) {
                    document.getElementById(campos[i]).style.display = accion;
                }
            ...
            function extintor(accion) {
                var campos = ['Odescripcion', 'marc', 'model', 'numInventario', 'respon', 'ubica', 'archivo', 'estado'];
